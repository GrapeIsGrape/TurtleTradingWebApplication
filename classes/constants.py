...
MARKET_CLOSE_EXIT_RESULT_FILE_NAME = 'market_close_exit_result.log'
MARKET_OPEN_EXIT_RESULT_FILE_NAME = 'market_open_exit_result.log'
MAIN_LOG_MARKET_CLOSE_BREAKOUT_FILE_NAME = 'main_log_market_close_breakout.log'
MAIN_LOG_MARKET_OPEN_BREAKOUT_FILE_NAME = 'main_log_market_open_breakout.log'
MAIN_LOG_MARKET_CLOSE_EXIT_FILE_NAME = 'main_log_market_close_exit.log'
MAIN_LOG_MARKET_OPEN_EXIT_FILE_NAME = 'main_log_market_open_exit.log'
MAIN_LOG_FILL_MARKET_DATA_FILE_NAME = 'main_log_fill_market_data.log'
